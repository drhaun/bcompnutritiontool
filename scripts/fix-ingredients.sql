...
-- Generated on 2026-02-06T03:54:07.466Z
-- Total recipes: 124
...
UPDATE ni_recipes SET 
  ...
  directions = ARRAY['In a mason jar, add the almond milk and protein powder.','Tighten the lid and shake it so the protein powder combines with the milk.','Add other ingredients.','Close the lid and shake to combine.','Place your jar in the refrigerator for at least 2 hours or overnight.','Stir before eating and enjoy!']::text[]
...
UPDATE ni_recipes SET 
  ...
  directions = ARRAY['Cook the eggs and sausage first in separate pans.','Add the spinach in the pan with the eggs.','Once those are cooked, heat the tortilla in the microwave for 5 seconds.','Then build the burrito using eggs with spinach first, then sausage, and adding cheese on top.','Fold tightly and enjoy!']::text[]
...
UPDATE ni_recipes SET 
  ...
  directions = ARRAY['For the egg whites, use a muffin pan and pour 3 tbsp in each tin.','Bake for 10 minutes at 350°F.','While those are cooking, heat the English muffin and cheese in a toaster oven and microwave the turkey sausage patty according to the package directions.','Then stack the egg white muffin and sausage patty on the English muffin.']::text[]
...
UPDATE ni_recipes SET 
  ...
  directions = ARRAY['Preheat the oven to 350°F.','Spray a 6 muffin tin with cooking spray.','Mix egg whites, cheese, spinach, and salt and pepper.','Pour mixture evenly among tins.','Cook for 18 minutes or until the eggs are cooked all the way through.','Let cool before eating. Enjoy!']::text[]
...
UPDATE ni_recipes SET 
  ...
  directions = ARRAY['Toast bread according to preference.','Dice avocado into small pieces and sprinkle salt and pepper on the pieces.','Once bread is finished toasting, spread avocado onto toast and mash into a jam like consistency.','Cook chicken breast according to preference and top with cheese to melt.','Place on slice of toast and top with other piece of toast and enjoy!']::text[]
...
UPDATE ni_recipes SET 
  ...
  directions = ARRAY['Combine all ingredients for the turkey burgers in a large bowl.','Form into patties.','On stove top, heat a large skillet and cook for 5 minutes, flip, then turn the heat to medium low. Cover for the next 5 minutes until all burgers are cooked.','Preheat oven to 375 and cook for ~25 minutes.','Serve with bun, fries, Greek salad, etc.']::text[]
...
UPDATE ni_recipes SET 
  ...
  directions = ARRAY['Preheat oven to 375°F.','Slice chicken into half inch strips.','Put the strips in a bowl and toss them in the fajita and ranch seasonings.','Bake for about 20 mins, or until they are cooked completely.']::text[]
...
UPDATE ni_recipes SET 
  ...
  directions = ARRAY['Cut the salmon fillet into 1-inch pieces.','In a food processor or blender, add salmon cubes, mustard, herbs, salt, pepper, and paprika.','Pulse until mixed together well. There should be some small chunks.','Transfer salmon mixture to a medium-sized bowl.','Add the breadcrumbs and mix with a spatula until combined.','Evenly divide the salmon mixture into four portions (about 4-oz. each) then shape into patties.','Cook on the stovetop over medium high heat until the fillet is golden brown.','Flip and let it cook for a few more minutes.']::text[]
...
UPDATE ni_recipes SET 
  ...
  directions = ARRAY['In a bowl, mix BBQ sauce, vinegar, onion and garlic powder.','Place chicken breasts in the bottom of the crockpot.','Pour the sauce over the chicken and cook chicken on high for 2-3 hours or until completely cooked.','Shred the chicken once finished cooking.']::text[]
...
UPDATE ni_recipes SET 
  ...
  directions = ARRAY['Preheat oven to 400°F.','Place in a large baking dish and toss the diced sweet potatoes with 2 tbsp olive oil, 1/2 tsp garlic powder, 1/2 tsp rosemary, salt, and pepper.','Bake the sweet potatoes for 30 minutes.','While sweet potatoes are in the oven, sauté the ground turkey in a pan with 1 tbsp olive oil, 1 tsp garlic powder, 1/2 tsp rosemary, salt, and pepper.','Remove the sweet potato from the oven.','Layer the ground turkey and diced zucchini on top of the sweet potatoes.','Bake for 10 minutes.','Add in an additional 2 tbsp olive oil, mix, and top with the shredded parmesan cheese.','Bake for 10 minutes.']::text[]
...
UPDATE ni_recipes SET 
  ...
  directions = ARRAY['Combine all ingredients in a crockpot and cook on low for 8 - 10 hours or on high for 4 to 6 hours.','Add avocado slices on top before serving.']::text[]
...
UPDATE ni_recipes SET 
  ...
  directions = ARRAY['Preheat the oven: Preheat your oven to 375°F (190°C).','Blanch the green beans: Bring a large pot of water to a boil. Add the green beans and cook for 3-4 minutes, then immediately transfer them to a bowl of ice water to stop the cooking process. Drain and set aside.','Make the mushroom sauce:In a large skillet, heat the olive oil over medium heat. Add chopped onions and garlic, sautéing until softened.','Add sliced mushrooms and cook until they release their moisture and become golden brown.','Sprinkle flour over the mushroom mixture and stir well to coat. Cook for 1-2 minutes to remove the raw flour taste.','Slowly whisk in the vegetable broth and almond milk. Stir continuously until the mixture thickens.','Season with salt, pepper, and dried thyme. Allow the sauce to simmer for a few minutes until it reaches a creamy consistency.','Assemble the casserole:Add the blanched green beans to the mushroom sauce, stirring until well coated.','Transfer the mixture to a lightly greased baking dish.','Prepare the topping:In a small bowl, mix the whole grain breadcrumbs with grated Parmesan cheese (if using).','Sprinkle the breadcrumb mixture evenly over the green bean mixture.','Bake:Bake in oven for 20-25 minutes or until the top is golden brown and the casserole is bubbling around the edges.','Serve:Allow the casserole to cool for a few minutes before serving.','Enjoy your healthier green bean casserole!']::text[]
...
UPDATE ni_recipes SET 
  ...
  directions = ARRAY['Preheat oven to 350°F.','Chop the apples and sauté them along with cinnamon, salt, and coconut oil in a pan at medium high heat for 2-3 minutes.','In a food processor, mix all crumble ingredients with 1 tbsp of water until throughly combined.','Add crumble and apple mixture to a small baking pan and bake for 15-20 minutes.']::text[]
...
UPDATE ni_recipes SET 
  ...
  directions = ARRAY['Preheat the oven to 350°F.','In a large mixing bowl, combine all base ingredients, and mix well.','Bake for 20-25 minutes, or until completely cooked.','Remove from the oven and allow it to cool in the pan for 15 minutes, before carefully transferring to a wire rack to cool completely.','Once cool, drizzle the topping.']::text[]
...
UPDATE ni_recipes SET 
  ...
  directions = ARRAY['Preheat the oven to 400°F.','Cook turkey bacon according to package instructions and then cut up into small pieces.','Add olive oil, broccoli, onion, salt, garlic powder, and pepper to a pan and sauté over medium heat.','In a bowl, whisk the eggs, bacon, and cheese.','Pour pan contents into the bowl and mix throughly.','In a six count muffin tin, distribute mix evenly and bake for 15-20 minutes or until completely cooked.']::text[]
...
UPDATE ni_recipes SET 
  ...
  directions = ARRAY['Preheat oven to 375°F degrees.','Spray a casserole dish with cooking grease and set aside.','Heat a skillet over medium-high heat.','Brown turkey sausage and drain excess grease from skillet. Set aside.','In a blender, add egg whites, cottage cheese, and seasonings. Blend until creamy.','Pour the blended egg mixture into the bottom of the greased casserole dish and add the cooked turkey sausage.','Sprinkle ½ of the cheese across the top.','Evenly distribute the tater tots across the top of the casserole and add the remaining cheese.','Bake at 375°F for 40 mins.']::text[]
...
UPDATE ni_recipes SET 
  ...
  directions = ARRAY['Preheat oven to 350°F.','Microwave riced cauliflower according to package instructions.','Combine all ingredients, including cooked cauliflower, in a large bowl and mix.','Pour mixture into a casserole dish and bake for 35 minutes.']::text[]
...
UPDATE ni_recipes SET 
  ...
  directions = ARRAY['Cook chicken, black beans, chickpeas, and shallots prior to assembling salad.','Chop peppers and onions.','In a large bowl, add cooked ingredients and chopped vegetables to lettuce.','Toss with Primal Kitchen cilantro lime dressing.']::text[]
...
UPDATE ni_recipes SET 
  ...
  directions = ARRAY['Cook ground beef in fry pan.','Add Worcestershire sauce, ketchup, minced onion, salt, and pepper to beef and stir.','Lay Lavash bread sheets flat and sprinkle cheese on each.','Add beef, lettuce, and tomato to Lavash bread.','Wrap filling up in Lavash bread and heat on each side for 2-3 minutes or until lightly browned.']::text[]
...
UPDATE ni_recipes SET 
  ...
  directions = ARRAY['Add Oreos to a bag and crush them.','Then, add all the ingredients to a bowl and mix!','Pair with graham crackers, pretzels, etc.','Enjoy!']::text[]
...
UPDATE ni_recipes SET 
  ...
  directions = ARRAY['Add all ingredients to a blender.','Blend until smooth.','Enjoy!']::text[]
...
UPDATE ni_recipes SET 
  ...
  directions = ARRAY['Chop eggs.','Combine with mayonnaise, mustard, chives, salt, and pepper.']::text[]
...
UPDATE ni_recipes SET 
  ...
  directions = ARRAY['Preheat oven to 350°F.','Line a baking sheet with parchment paper.','In a large bowl, combine all ingredients, stirring until well mixed.','Place 2 tablespoon sized scoops onto the baking sheet. Flatten slightly, forming the shape of a cookie.','Bake for 14-17 minutes, or until the edges begin to brown.','Remove from the oven and cool.']::text[]
...
UPDATE ni_recipes SET 
  ...
  directions = ARRAY['Add all ingredients to a blender.','Blend until mixed well.']::text[]
...
UPDATE ni_recipes SET 
  ...
  directions = ARRAY['In a container with an airtight lid or a mason jar, pour cashew milk into container.','Add in chia seeds, peanut butter powder, and protein powder.','Put the top on the container and shake for 15 seconds.','Put the container in the refrigerator for 1 hour.','Take container out and shake it again for 15 seconds.','Let sit for 3 more hours in the refrigerator before enjoying']::text[]
...
UPDATE ni_recipes SET 
  ...
  directions = ARRAY['Cook pasta according to package directions.','While pasta is cooking, heat olive oil in a skillet.','Add garlic and sauté for 1 minute.','Add ground beef and seasonings to skillet and cook until done.','Pre-heat oven to 375 and spray a casserole dish with cooking spray.','In a large mixing bowl, add ground beef, pasta, 2 cups marinara, half of the mozzarella, cottage cheese, and egg.','Add ½ cup of marinara to the bottom of the casserole dish and spread with a spoon.','Then, add in the contents of the mixing bowl to dish.','Top dish with another ½ cup of marinara and remaining cheese.','Bake for 25 minutes.']::text[]
...
UPDATE ni_recipes SET 
  ...
  directions = ARRAY['Blend together banana, spinach, Greek yogurt, protein powder, almond milk, and optional sweetener.','Adjust consistency with more almond milk or ice if needed.','Pour into glass or bowl.','Top with coconut flakes, sliced kiwi, and muesli.','Enjoy your green smoothie!']::text[]
...
UPDATE ni_recipes SET 
  ...
  directions = ARRAY['Blend ingredients until smooth.','Spread date syrup on inside of glass.','Pour into glass and enjoy.']::text[]
...
UPDATE ni_recipes SET 
  ...
  directions = ARRAY['Blend together banana, berries, spinach, Greek yogurt, protein powder, almond milk, and optional sweetener.','Adjust consistency with more almond milk or add ice if needed.','Pour into glass and enjoy!']::text[]
...
UPDATE ni_recipes SET 
  ...
  directions = ARRAY['Blend together banana, peanut butter, Greek yogurt, protein powder, almond milk, and optional ingredients.','Adjust consistency with more almond milk or add ice if needed.','Pour into glass and enjoy!']::text[]
...
UPDATE ni_recipes SET 
  ...
  directions = ARRAY['Blend together mango, pineapple, banana, Greek yogurt, protein powder, coconut milk, and optional sweetener.','Adjust consistency with more almond milk or add ice if needed.','Pour into glass and enjoy!']::text[]
...
UPDATE ni_recipes SET 
  ...
  directions = ARRAY['Blend together banana, cocoa powder, Greek yogurt, protein powder, almond milk, and optional sweetener.','Adjust consistency with more almond milk or add ice if needed.','Pour into glass and enjoy!']::text[]
...
UPDATE ni_recipes SET 
  ...
  directions = ARRAY['Place chicken breasts in the bottom of the crockpot.','Mix the Greek yogurt, lemon zest and juice, salt, garlic, and dill in a bowl.','Pour half of the marinade over the chicken.','Cook on high for 4 hours or low for 6-8 hours.','Once done, remove chicken and shred with forks.','Drain off all but about 1/2 cup of remaining juices and add your chicken back to the pot.','Mix in the remaining marinade and you’ve got yourself a delicious protein packed dish for dinner.','Serve with rice, pita bread, sliced cucumber, chopped tomato, sliced red onions, and/or fresh parsley.']::text[]
...
UPDATE ni_recipes SET 
  ...
  directions = ARRAY['Spread Greek yogurt on parchment paper','Add sliced strawberries','Add granola','Freeze until yogurt is firm','Remove from freezer, and break into pieces','Enjoy!']::text[]
...
UPDATE ni_recipes SET 
  ...
  directions = ARRAY['In a mason jar, add oats, scoop of protein, and unsweetened almond milk.','Tighten the lid and shake until the protein powder, oats, and milk combine.','Open jar and top with strawberries.','Place your jar in the refrigerator for at least 2 hours or overnight.','Stir before eating and enjoy!']::text[]
...
UPDATE ni_recipes SET 
  ...
  directions = ARRAY['Add ingredients to food processor.','Process on low speed until ingredients are well mixed.','Roll mixture into twelve balls and place on parchment lined pan.','Bake at 400 degrees F for 15-20 minutes.','Flip meatballs halfway through cooking time.','Top with additional buffalo sauce and green onion.']::text[]
...
UPDATE ni_recipes SET 
  ...
  directions = ARRAY['Add ingredients to a food processor.','Blend until smooth.','Serve in a small dish and top with your favorite topping!']::text[]
...
UPDATE ni_recipes SET 
  ...
  directions = ARRAY['Mix wet ingredients.','Mix dry ingredients in separate bowl.','Add dry ingredients into wet ingredients.','Mix thoroughly.','Pour mixture into parchment lined loaf pan.','Sprinkle (or mix in) chocolate chips.','Bake for 35-45 minutes on 350 or until fully cooked.']::text[]
...
UPDATE ni_recipes SET 
  ...
  directions = ARRAY['Mix the Greek yogurt, pumpkin puree, and pumpkin pie spice in bowl.','Place granola at bottom of serving dish.','Scoop yogurt mixture over granola.','Top with toppings of choice.']::text[]
...
UPDATE ni_recipes SET 
  ...
  directions = ARRAY['Froth or whisk matcha and water.','Add maple butter and salt and continue to whisk/froth.','Pour matcha mixture over ice & 1/4c milk','Use remaining milk to collect remaining matcha mixture from mug and pour over ice.5. Stir & Enjoy']::text[]
...
UPDATE ni_recipes SET 
  ...
  directions = ARRAY['Cook quinoa according to package instructions. Use bone broth in place of water.','Cut sweet potatoes into cubes and microwave on high for 4 minutes to soften.','Slice chicken sausages into rounds and place on sheet pan with sweet potatoes and broccoli. Toss in oil, salt, and pepper.','Bake chicken sausage, sweet potato, and broccoli at 400 degrees for 20-25 minutes.','While ingredients are cooking, chop green onion into small rounds and crush a handful of almonds.','When finished cooking, scoop quinoa into dish.','Serve chicken sausage, sweet potatoes, and broccoli over quinoa.','Top with chopped green onion and sliced almonds']::text[]
...
UPDATE ni_recipes SET 
  ...
  directions = ARRAY['Mix ingredients together until desired consistency, adding extra flour or protein powder as needed.','Store in fridge and enjoy throughout the week.']::text[]
...
UPDATE ni_recipes SET 
  ...
  directions = ARRAY['Mix ingredients to make sauce','Pour sauce over chicken in air tight container.','Marinate chicken in fridge for 2-4 hours or overnight','Add potatoes and green beans to pan and cover with olive oil, salt, and pepper.','Add marinated chicken to pan.','Bake for 30 mins at 400 degrees Fahrenheit or until chicken reaches internal temperature of 165 degrees Fahrenheit.','Separate into 4-5 servings and store in fridge.']::text[]
...
UPDATE ni_recipes SET 
  ...
  directions = ARRAY['Preheat your oven to 375°F (190°C).','Cut the tops off the large bell peppers and remove seeds and membranes. Lightly brush the insides with olive oil and set them in a baking dish.','Heat 1 tbsp olive oil in a large skillet over medium heat.','Add the ground beef, breaking it up with a spoon, and cook until browned (about 5 minutes).','Add the onion, diced bell pepper, and garlic, cooking until softened (about 3–4 minutes).','Stir in the smoked paprika, oregano, chili powder (if using), salt, and pepper.','Stir in the cooked rice and drained diced tomatoes. Mix well and cook for 2–3 minutes to let the flavors meld. Taste and adjust seasonings if necessary.','Spoon the beef and rice mixture into each bell pepper, packing it firmly but not overfilling.','Top each stuffed pepper with a generous sprinkle of shredded cheese.','Cover the baking dish with foil and bake for 25 minutes.','Remove the foil and bake for an additional 10 minutes, or until the peppers are tender and the cheese is bubbly and golden.','Let the stuffed peppers cool slightly before serving.']::text[]
...
UPDATE ni_recipes SET 
  ...
  directions = ARRAY['Preheat the oven to 375 degrees.','Cook brown rice as directed on packaging.','Cut eggplant and broccoli as desired and spread on the roasting sheet. Add olive oil, salt, pepper, and garlic power over veggies and toss to combine.','Roast veggies for 30 minutes.','In a small bowl combine coconut aminos, honey, olive oil,','Cut steak to desired sized pieces and place in marinade.','On medium heat, place steak in a pan and cook until done.','Remove steak from pan and add onions to the same heated pan.','Cook onions until soft and caramelized.','Optional: Top bowl with green onions and avocado','For a delicious Korean BBQ bowl place rice on bottom and layer serving of eggplant, broccoli, and onions. Add shredded steak and top with green onions and avocado.']::text[]
...
UPDATE ni_recipes SET 
  ...
  directions = ARRAY['Oil pan.','Cook ground turkey in pan on medium heat.','Add 1 pack of cole slaw to pan and cover.','Cook on medium heat until slaw is lightly browned.','Add coconut amino sauce as desired.']::text[]
...
UPDATE ni_recipes SET 
  ...
  directions = ARRAY['Pre-cook chicken','Smash avocado on a tortilla','Sprinkle salt and oregano on smashed avocado','Add 4 ounces to chicken on top of avocado','Add chopped cucumbers and spinach to wrap','Roll tortilla with ingredients inside until a tight wrap','Brown on stovetop for 1 minute on each side']::text[]
...
UPDATE ni_recipes SET 
  ...
  directions = ARRAY['Cook chopped chicken in olive oil on low to medium heat in a large pan or wok.','Add egg once chicken is cooked partially through.','Add mixed veggies and put lid on pan.','While vegetables are cooking, add pad Thai noodles to a separate pot of boiling water. Follow instructions on noodle package.','When noodles are fully cooked, add to pan and combine.','Pour sauce over mixture and toss ingredients to mix.','Serve and enjoy!']::text[]
...
UPDATE ni_recipes SET 
  ...
  directions = ARRAY['Crumble tofu into small pieces','Season tofu with salt, pepper, cumin, paprika, and oregano to taste.','Oil pan and cook tofu on stovetop at medium heat or until lightly browned.','Heat tortilla','Add dairy free cheese and tofu to wrap and roll into burrito.','Brown burrito on stovetop until slightly crispy.']::text[]
...
UPDATE ni_recipes SET 
  ...
  directions = ARRAY['Heat bone broth, cocoa, maple syrup, soy milk, and cinnamon in a pot on low, stirring to mix ingredients and keep from burning.','Top with marshmallows and toss in a peppermint stick for a festive flavor!']::text[]
...
UPDATE ni_recipes SET 
  ...
  directions = ARRAY['Mix peppermint extract, yogurt, and chocolate protein powder in one bowl.','Top with smashed peppermint cookies and peppermint']::text[]
...
UPDATE ni_recipes SET 
  ...
  directions = ARRAY['Mix all ingredients in an air tight container.','Store in fridge overnight.','Remove from fridge, add sprinkles, and enjoy.']::text[]
...
UPDATE ni_recipes SET 
  ...
  directions = ARRAY['Mix (peppermint) double espresso with chocolate salt.','Pour milk over ice.','Pour espresso over milk & ice.','Stir and enjoy.']::text[]
...
UPDATE ni_recipes SET 
  ...
  directions = ARRAY['Cover rice cake with nut butter.','Sprinkle hemp seeds over nut butter.','Dip in melted dark chocolate.','Sprinkle crushed peppermint on top of melted chocolate.','Freeze for 10 minutes.']::text[]
...
UPDATE ni_recipes SET 
  ...
  directions = ARRAY['Brew double espresso in mug.','While brewing espresso, froth 1/2 c egg nog.','Pour frothed nog over espresso.','Top with nutmeg.','Enjoy hot or over ice.']::text[]
...
UPDATE ni_recipes SET 
  ...
  directions = ARRAY['Add oat nog, collagen, vanilla protein, and nutmeg to Ninja Creami pitcher.','Froth or blend contents to mix.','Place lid on container and freeze for at least 24 hours.','Place container in Ninja Creami and run on “lite ice cream” selection.','Add 3 TBSP oat nog and press ‘’re-spin”','Remove from machine & enjoy!']::text[]
WHERE slug = 'oat-nog-ninja-creami';

UPDATE ni_recipes SET 
  ingredients = '[{"item":"orange","amount":"1"},{"item":"pack of cranberries","amount":"1"}]'::jsonb,
  directions = ARRAY['Slice orange into rounds.','Place one orange slice into each ice cube mold.','Add a handful of cranberries into each mold.','Pour water (Or beverage of choice) to fill mold.','Freeze for at least 24 hours.']::text[]
...
UPDATE ni_recipes SET 
  ...
  directions = ARRAY['Mix oats, protein powder, collagen, cinnamon, nutmeg maple syrup, and almond milk together.','Store in fridge overnight or for a few hours.','Remove from fridge, top with dried cranberries, chopped pecans, and enjoy!']::text[]
...
UPDATE ni_recipes SET 
  ...
  directions = ARRAY['Precook chicken, broccoli, and sweet potatoes in the oven.','Fill bowl with pre-washed chopped kale.','Add chicken breasts, roasted sweet potatoes, and broccoli.','Sprinkle with pomegranate seeds and almonds.','Finish it off with a few drizzles of balsamic glaze.']::text[]
...
UPDATE ni_recipes SET 
  ...
  directions = ARRAY['Brew double shot over ginger, all spice, and coconut sugar.','Shake mixture in mason jar.','Pour over ice.','Add Gingerbread creamer!']::text[]
...
UPDATE ni_recipes SET 
  ...
  directions = ARRAY['Chop protein bar and apple into bite sized pieces.','Line cup or bowl with date syrup.','Layer apple, protein bar pieces, and yogurt into cup or bowl, adding in date syrup between layers as desired.','Top with date syrup, stir, & enjoy.']::text[]
...
UPDATE ni_recipes SET 
  ...
  directions = ARRAY['Blend ingredients in blender.','Heat non-stick pan on low.','Spoon batter onto pan, making pancakes of desired size.','Flip pancakes when batter starts to bubble.','Finish cooking to desired texture.']::text[]
...
UPDATE ni_recipes SET 
  ...
  directions = ARRAY['Cut sweet potato into thin slices.','Spray slices with oil.','Cook at 400 degrees F for 15-20 minutes or until lightly browned.','Add toppings of choice.']::text[]
...
UPDATE ni_recipes SET 
  ...
  directions = ARRAY['Blend ingredients in blender.','Top with peppermint.','Pour into festive cup & enjoy.This recipe is gluten and dairy free. To make IBS friendly use a firm banana and remove frozen cauliflower!']::text[]
...
UPDATE ni_recipes SET 
  ...
  directions = ARRAY['Preheat oven to 350 degrees F.','Blend all ingredients in blender.','Pour into oven safe dish.','Bake at 350 degrees F for 25-30 mins.']::text[]
...
UPDATE ni_recipes SET 
  ...
  directions = ARRAY['Heat 35g of water.','Combine with 3g (approx 2 tsp) of matcha.','Froth or whisk.','Add maple syrup, almond extract, and vanilla extract to mixture. Froth or whisk.','Scoop ice into sprinkle lined serving cup.','Pour milk of choice over ice.','Add in matcha mixture.','Stir and enjoy.']::text[]
...
UPDATE ni_recipes SET 
  ...
  directions = ARRAY['Peel and slice carrots.','Coat in olive oil and maple syrup.','Toss in seasonings.','Spread seasoned carrots onto baking pan.','Roast for 30 mins at 400 Degrees F']::text[]
...
UPDATE ni_recipes SET 
  ...
  directions = ARRAY['Mix all ingredients in bowl until thick (cookie dough-like) consistency.','Roll into balls.','Dip dough balls into sprinkle and cover completely.','Store in fridge and enjoy!']::text[]
...
UPDATE ni_recipes SET 
  ...
  directions = ARRAY['Slice bread into cubes.','Mix egg whites, oat nog, spices, collagen, and stevia in a bowl.','Place cubed bread into oven safe dish.','Pour liquid mixture over bread.','Bake at 400 degrees F for approximately 20 minutes or until lightly browned.','Top with nutmeg and syrup!']::text[]
...
UPDATE ni_recipes SET 
  ...
  directions = ARRAY['Mix coco whip, protein powder, and almond extract in bowl.','Top with sprinkles.','Dip your favorite cookie or dessert or eat it by the spoonful.']::text[]
...
UPDATE ni_recipes SET 
  ...
  directions = ARRAY['Sauté: Set Instant Pot to Sauté and cook onion, garlic, and ground beef until browned (5-7 minutes). If using ground beef with higher fat content, you may want to drain the fat. With ~93% lean beef, draining isn''t necessary.','Add Ingredients: Return the ground beef mixture to the pot. Add black beans, tomatoes, kidney beans, black-eyed peas, bone broth, spices, salt, and pepper. Lock the lid and Pressure Cook on High for 14 minutes.','Release Pressure: Perform a quick pressure release, then open the lid once fully released.','Serve: Divide chili into bowls and top with your favorite toppings.For Slow Cooker: Cook beef in a skillet, then transfer it along with all other ingredients to a slow cooker. Cook on Low for ~6 hours or High for ~3 hours.']::text[]
...
UPDATE ni_recipes SET 
  ...
  directions = ARRAY['Rim the coupe glass with rosemary and chill if desired.','Muddle raspberries with pomegranate juice in a shaker.','Add ice, shake, and strain into the glass.','Top with soda water.','Garnish with raspberries and a rosemary sprig.']::text[]
...
UPDATE ni_recipes SET 
  ...
  directions = ARRAY['Melt Chocolate: Using a double boiler or microwave in 30-second intervals, stirring in between, melt the chocolate until smooth.','Dip: Hold each strawberry by the stem, dip into the melted chocolate, and twist slightly to remove excess. If using toppings, dip immediately before placing on the baking sheet.','Drizzle (Optional): Drizzle leftover chocolate with a fork over the dipped strawberries. Can also opt to use a different chocolate (white or milk) for drizzle.','Set: Chill in the refrigerator for about 15 minutes until the chocolate hardens.','Enjoy! Store in a cool place and enjoy within 24 hours for the best taste.']::text[]
...
UPDATE ni_recipes SET 
  ...
  directions = ARRAY['Marinate Chicken: In a bowl, mix oil, spices, and salt. Add chicken, toss to coat, and marinate for 30 minutes (or up to 3 hours in the fridge).','Cook Rice: In a pot, bring rice, salt, and 3 cups water to a boil. Cover, reduce heat, and simmer for 15 minutes. Let sit for 10 minutes, then fluff with a fork.','Cook Chicken: Spray the pan with oil and heat over medium-high heat. Cook chicken for 5-7 minutes per side until golden brown and 165°F internally. Let rest for10 minutes, then slice.','Make Salad: In a bowl, combine cucumbers, bell peppers, onion, tomatoes, and feta. Add red pepper flakes, juice from 1 lemon, and 2 tsp. oil. Toss and season with salt.','Assemble Bowls: Divide rice among bowls. Top with chicken, salad, a 1 TBSP of tzatziki sauce, 1 TBSP hummus. Serve with pita.']::text[]
...
UPDATE ni_recipes SET 
  ...
  directions = ARRAY['In a medium bowl, combine the avocados, cucumbers, feta, cilantro, and green onions.','Add the olive oil and lemon juice and toss gently to mix.','Season with salt.']::text[]
...
UPDATE ni_recipes SET 
  ...
  directions = ARRAY['Season chicken with salt & pepper. Mix with harissa, lemon juice, and garlic. Let sit.','Toss sweet potatoes & onion with oil, cumin, salt & pepper. Spread on a baking sheet & bake at 425°F for 10-15 min.','Nestle chicken into the veggies & bake for another 20-25 min until chicken reaches 165°F.','Top with cilantro & serve with lemon wedges.']::text[]
...
UPDATE ni_recipes SET 
  ...
  directions = ARRAY['In a food processor or blender, combine all ingredients until smooth. Make sure chocolate chips are melted prior to mixing.']::text[]
...
UPDATE ni_recipes SET 
  ...
  directions = ARRAY['Make the seasoning: In a small bowl, mix together chili powder, paprika, cumin, onion powder, salt, garlic powder, and a pinch of cayenne.','Season the chicken: Place the chicken breasts on a cutting board. Sprinkle half the seasoning on top and rub it in. Flip the chicken and repeat with the rest of the seasoning.','Cook the chicken: Heat 2 tsp oil in a large pan over medium-high heat. Add the chicken in a single layer. Cook for about 4 minutes, then flip and cook another 3–5 minutes until fully cooked. Remove from heat.','Sauté the corn: In the same or a separate pan, sauté corn over medium-high heat until it starts to brown and lightly char, about 5–7 minutes.','Make the street corn mix: In a bowl, combine the sautéed corn with chopped cilantro, Greek yogurt, and seasonings (like chili powder, lime juice, and a pinch of salt). Mix until well combined.','Serve: Top chicken with street corn. Serve with roasted potatoes or a salad for a well balanced meal.']::text[]
...
UPDATE ni_recipes SET 
  ...
  directions = ARRAY['Preheat the oven to 425°F. Lightly spray a baking sheet with olive oil to coat or line with parchment paper.','Prepare the filling: In a mixing bowl, combine the shredded chicken, Greek yogurt, salsa, cumin, paprika, garlic powder, and a pinch of salt and pepper. Stir until everything is well combined.','Warm the tortillas so they don’t break while rolling:Oven: 1–2 minutes','Microwave: 45–60 seconds (between damp paper towels)','Assemble the tacos:Distribute the creamy salsa chicken onto each tortilla.','Top with shredded cheddar.','Fold the tortilla over and place it on the prepared baking sheet.','Repeat with remaining tortillas.','Brush or spray the outsides of the folded tortillas with olive oil and top with remaining cheese if desired.','Bake for 12–15 minutes, until the tacos are crispy and golden brown.','Serve immediately with pickled onions, sour cream or Greek yogurt, cotija cheese, fresh cilantro, and lime wedges for spritzing. Also pairs great with this Easy Pico.']::text[]
