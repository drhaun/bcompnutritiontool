...
with tab2:
    ...
    **Why this matters:** 
    ...
    st.markdown(f"""
    **Calories Breakdown:**
    - Total: {target_calories} calories
    - Protein: {macros['protein']}g × 4 = {protein_cals} calories ({protein_pct}%)
    - Carbs: {macros['carbs']}g × 4 = {carbs_cals} calories ({carbs_pct}%)
    - Fat: {macros['fat']}g × 9 = {fat_cals} calories ({fat_pct}%)
    """)
