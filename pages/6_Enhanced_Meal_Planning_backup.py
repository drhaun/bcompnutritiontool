...
def food_search_ui(section_key="main"):
    ...
    with search_col1:
        search_query = st.text_input(
            ...
            key=f"food_search_{section_key}"
        )
    
    with search_col2:
        search_button = st.button("Search", use_container_width=True, key=f"search_btn_{section_key}")
