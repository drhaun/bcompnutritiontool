...
const PROTEINS = ['Chicken Breast', 'Chicken Thighs', 'Ground Chicken', 'Ground Turkey', 'Turkey Breast', 'Salmon', 'Tuna', 'Shrimp', 'Cod/White Fish', 'Ground Beef', 'Steak', 'Bison', 'Lamb', 'Pork Tenderloin', 'Bacon', 'Eggs', 'Egg Whites', 'Tofu', 'Tempeh', 'Greek Yogurt', 'Cottage Cheese', 'Whey Protein', 'Plant Protein', 'Turkey Sausage', 'Sardines', 'Venison'];
